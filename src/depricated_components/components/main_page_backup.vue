            ...
            <div v-if="has_read_access">
                ...
                <div>
                    <nav-bar v-bind:gridOptions="gridOptions" v-bind:new_input_params="new_input_params" 
                        v-bind:rowData="rowData" v-bind:pagination="pagination" v-bind:server_fields="gridParams.field_variables.server_fields"
    ...
    async mounted () {
        ...
        */
        try {
            ...
            await this.CrudTest()
            // Append gridParam fields?
            this.page_status.initial_loading = false
        } catch (err) {
            this.page_status.initial_loading_error = err
        }
    },
    computed: {
    ...
    methods: {
        ...
        async UserPermissionsInitialize() {
            /*
                ...
                //find one specialty?
            */
            this.user_permissions['allow_read'] = true
            this.user_permissions['allow_insert'] = false
            this.user_permissions['allow_update'] = false
            this.user_permissions['allow_deactivate'] = false
            this.user_permissions['allow_delete'] = false
            this.user_permissions['is_admin'] = true
            this.user_permissions['is_assigned'] = true //true //has atleast on active specialty assigned.
            //has specialty_permissions?
        },
        async CrudTest() {
